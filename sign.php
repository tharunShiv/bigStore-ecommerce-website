    ...
    <form class="col s12" method="POST" enctype="multipart/form-data">
      <div class="row">
        ...
        <div class="input-field col s6">
          ...
          <input id="icon_prefix" type="text" name="email" class="validate" required placeholder="Email">
        ...
        <div class="input-field col s6">
          ...
          <input id="icon_prefix" type="text" name="lastname" class="validate" required placeholder="Lastname">
          
        </div>

        <div class="input-field col s6">
          <i class="material-icons prefix">lock</i>
          <input id="icon_prefix" type="password" name="password" class="validate value1" required placeholder="password">
          
        </div>

        <div class="input-field col s6">
          <i class="material-icons prefix">lock</i>
          <input id="icon_prefix" type="password" name="confirmation" class="validate value2" required placeholder="Confirm Password">
          
        </div>

        <div class="input-field col s6">
          <i class="material-icons prefix">business</i>
          <input id="icon_prefix" type="text" name="city" class="validate" required placeholder="City">
          
        </div>

        <div class="input-field col s6 meh">
          <i class="material-icons prefix">location_on</i>
          <input id="icon_prefix" type="text" name="address" class="validate" required placeholder="Address">
      ...
      <div id="test1" class="col s12 left-align">
       ...
       <form class="col s12" method="POST">
           ...
           <div class="input-field col s12">
             <i class="material-icons prefix">email</i>
             <input id="icon_prefix" type="text" name="emaillog" class="validate" placeholder="Email">
           </div>
